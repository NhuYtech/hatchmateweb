      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[1680px] gap-6 px-4 py-5 xl:px-8">
        ...
        <main className="flex min-h-screen flex-1 flex-col gap-6 min-w-0">
          ...
          <div className="grid gap-6">
            ...
            {/* 4. Incubation Phase Table Placeholder */}
            <div className="rounded-[24px] border border-sky-100/80 bg-white p-6 shadow-sm shadow-sky-100/10">
              <div className="mb-4">
                <h3 className="text-xs font-bold uppercase tracking-[0.15em] text-slate-400">
                  Incubation Phase Table Placeholder
                </h3>
                <p className="text-xs text-slate-500 mt-1">Bảng thiết lập các giai đoạn ấp theo từng ngày (Đầu kỳ, Giữa kỳ, Sát nở)</p>
              </div>
              ...
              <div className="border border-dashed border-slate-200 rounded-[20px] p-6 text-center bg-slate-50/50">
                ...
                <p className="text-xs font-bold text-sky-950">Biểu đồ / Bảng tiến trình giai đoạn</p>
                <p className="text-[11px] text-slate-500 mt-1 max-w-md mx-auto">
                  Chia chu kỳ 21 ngày thành các giai đoạn: Ngày 1-6 (phát triển phôi), Ngày 7-18 (tạo hình), Ngày 19-21 (chuẩn bị nở) với nhiệt độ giảm dần và độ ẩm tăng dần.
                </p>
              </div>
            </div>
